...
// Add next billing text element after plan container if not present
let nextBillingTextEl = modalContent.querySelector('#nextBillingText');
if (!nextBillingTextEl) {
  nextBillingTextEl = document.createElement('p');
  nextBillingTextEl.id = 'nextBillingText';
  nextBillingTextEl.style.cssText = 'color:#9fb0db;font-size:13px;margin-top:8px;';
  modalContent.querySelector('#planCardContainer').after(nextBillingTextEl);
}
